...
LOG_FOLDER = Path(__file__).parent.parent / "logs" / "compare_reconstruction_results"
CSV_OUTPUT = Path(__file__).parent.parent / "logs" / "compare_reconstruction_results.csv"
DEDUPLICATE = True
